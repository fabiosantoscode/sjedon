...
Sjedon.Function.prototype.apply = function () {
    notimplemented('applying sjedon functions');
}

Sjedon.Function.prototype.wrap = function () {
    notimplemented('creating wrapper functions');
    /*
    var self = this;
...
Sjedon.prototype.evalExpression = function (expr) {
    if (expr.type === 'CallExpression') {
        ...
        return new Sjedon.Function({ expr: expr, sjedon: this });
