...
Sjedon.prototype.evalExpression = function (expr) {
    ...
    if (expr.type === 'SjedonQuotedExpression') {
        ...
        return this.callFunction(expr.callee, null, undefined, expr['arguments'].map(this.evalExpression.bind(this)));
...
// Why 2 functions? TODO If there's a reason to have them, at least document it.
Sjedon.prototype.callFunction = function (callee, closure, context, args) {
    ...
    if (callee.type === 'Identifier' || callee.type === 'MemberExpression') {
        ...
        if (typeof func === 'function') {
            ...
            return this.runFunction(func, closure, context, args)
        }
