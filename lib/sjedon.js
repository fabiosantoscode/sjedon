...
Sjedon.prototype.makeFunction = function (func, closure) {
...
Sjedon.prototype.callFunction = function (callee, closure, context, args) {
    args = args || [];
    if (callee.type === 'Identifier' || callee.type === 'MemberExpression') {
        ...
        if (typeof func === 'function') {
            ...
            this.runFunction(func, closure, context, args)
        }
    } else if (callee.type === 'FunctionExpression' || callee.type === 'FunctionDeclaration') {
        return this.runFunction(callee, closure, context, args);
    } else {
