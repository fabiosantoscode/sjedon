...
ExecutionContext.prototype.assignVar = function (name, value) {
...
ExecutionContext.prototype.fetchVar = function (name) {
...
Sjedon.prototype.eval = function (block) {
    this.stack = [];
    return this.currentFrame._eval(block || this.ast.body);
}

Sjedon.prototype.evalExpression = function (expression) {
    return this.currentFrame._evalExpression(expression)
}

// TODO this is just for the tests using it
Sjedon.prototype._evalCall = function () {
    return this.currentFrame._evalCall.apply(this.currentFrame, arguments)
}
