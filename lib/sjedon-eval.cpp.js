...
ExecutionContext.prototype._evalExpression = function (expr) {
    return this._evalMain(expr);
}

ExecutionContext.prototype._evalStatement = function (statement) {
    return this._evalMain(statement);
}

ExecutionContext.prototype._evalMain = function (ast) {
    var ret;
    var self = this;
     ...
     **/
        ...
        return this._evalCall(ast.callee, undefined, ast['arguments'].map(this._evalExpression.bind(this)));
        ...
        return this._evalFunction(ast, this /* TODO this is already the context */);
    } else if (ast.type === 'AssignmentExpression') {
        return this._evalAssignment(ast);
        ...
        if (ast.operator !== 'delete') {
            ...
            if (ast.argument.type === 'MemberExpression') {
                return this.sjedon.propertyDelete(
                    ...
                    this.maybeIdentifier(ast.argument.property));
            } else {
        ...
        return this._evalTernaryExpression(ast.test, ast.consequent, ast.alternate);
    } else if (ast.type === 'Identifier') {
        return this.fetchVar(ast.name)
    } else if (ast.type === 'MemberExpression') {
        return this._evalPropertyAccess(ast)
